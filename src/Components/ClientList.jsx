...
import { setSelectedClient } from '../slices/selectedClientSlice'; // Adjust path
          ...
          {filteredClients.map(client => (
            <tr key={client._id}>
              ...
              <td className="border p-2 space-x-2">
                <button onClick={() => handleEdit(client)} className="text-blue-500"><Pencil size={18} /></button>
                <button onClick={() => handleDelete(client._id)} className="text-red-500"><Trash2 size={18} /></button>
                <button onClick={() => handleCreateInvoice(client)} className="text-green-600"><FileText size={18} /></button>
              </td>
            </tr>
          ))}
        </tbody>
